...
- **RunPod next run:** [`docs/RUNBOOK.md`](docs/RUNBOOK.md) — network volume setup (console), [`scripts/runpod_seed_workspace.sh`](scripts/runpod_seed_workspace.sh) (one-time `/workspace` populate), then [`scripts/runpod_preflight.sh`](scripts/runpod_preflight.sh), [`scripts/runpod_train.sh`](scripts/runpod_train.sh), [`scripts/runpod_finish.sh`](scripts/runpod_finish.sh).
